...
> 📖 **Datasheet Reference:** I2C0 base address is `0x40090000` and I2C1 base address is `0x40098000` (Section 2.2, p. 33; Section 12.1, p. 1009). The `i2c_hw_t` struct in the Pico SDK maps directly to these memory-mapped I/O registers.
