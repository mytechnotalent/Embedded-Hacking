...
> 📖 **Datasheet Reference:** The RP2350 SRAM base address is `0x20000000` (Section 2.2, p. 31). SRAM banks SRAM0–SRAM7 provide 8 × 64 KB = 512 KB of striped SRAM, with SRAM8 and SRAM9 providing an additional 2 × 4 KB (Section 2.2.3, p. 32; Section 4.2, p. 338). Stack-allocated structs and local variables reside in this SRAM region.
