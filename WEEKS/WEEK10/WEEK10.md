...
> 📖 **Datasheet Reference:** UART0 base address is `0x40070000` and UART1 is `0x40078000` (Section 2.2, p. 33; Section 12.4, p. 1029). The flash XIP base at `0x10000000` is where the vector table and application code reside (Section 2.2, p. 31).
