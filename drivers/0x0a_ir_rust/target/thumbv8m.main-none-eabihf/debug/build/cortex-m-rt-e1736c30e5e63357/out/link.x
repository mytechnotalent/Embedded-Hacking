...
ASSERT(SIZEOF(.vector_table) <= 0x800, "
There can't be more than 496 interrupt handlers. This may be a bug in
your device crate, or you may have registered more than 496 interrupt
handlers.");
